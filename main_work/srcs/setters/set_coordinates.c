...
/*   Updated: 2022/06/07 11:50:02 by ljohnson         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int	rt_set_coordinates(float p_xyz[3], char *value, char *name)
{
	...
	dprintf(STDOUT_FILENO, "float p_xyz[0]: %f\n", p_xyz[0]);
	dprintf(STDOUT_FILENO, "float p_xyz[1]: %f\n", p_xyz[1]);
	dprintf(STDOUT_FILENO, "float p_xyz[2]: %f\n", p_xyz[2]);
